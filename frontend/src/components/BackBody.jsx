...
function BackBody({ onBodyPartClick }) {
    return (
        <div class="svg-container">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 660.46 1206.46" class="svg-box">
            <g id="calves" class="bodymap" onClick={() => onBodyPartClick("calves")}>
                <path
            ...
            <g id="traps" class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100" onClick={() => onBodyPartClick("traps")}>
                <path
            ...
            <g id="hamstrings" class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100" onClick={() => onBodyPartClick("hamstrings")}>
                <path
            ...
            <g id="glutes" class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100" onClick={() => onBodyPartClick("glutes")}>
                <path
            ...
            <g id="hands" class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100" onClick={() => onBodyPartClick("hands")}>
                <path
            ...
            <g id="forearms" class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100" onClick={() => onBodyPartClick("forearms")}>
                <path
            ...
            <g id="triceps" class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100" onClick={() => onBodyPartClick("triceps")}>
                <path
            ...
            <g id="lats" class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100" onClick={() => onBodyPartClick("lats")}>
                <path
            ...
            <g id="lowerback" class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100" onClick={() => onBodyPartClick("lowerback")}>
                <path
            ...
            <g id="traps-middle" class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100" onClick={() => onBodyPartClick("traps-middle")}>
                <path
            ...
            <g id="rear-shoulders" class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100" onClick={() => onBodyPartClick("rear-shoulders")}>
                <path
